      ...
      <div className="max-w-[760px] mx-auto px-6">
        ...
        <div className="h-14 flex items-center justify-between">
          <Link href="/" aria-label="Home" className="p-2 -ml-2 opacity-90 hover:opacity-100 transition-opacity">
            <svg width="124" height="28" viewBox="0 0 124 28" xmlns="http://www.w3.org/2000/svg">
              <rect width="124" height="28" rx="2" fill="#f59e0b"/>
              <rect x="2" y="2" width="120" height="24" rx="1" fill="none" stroke="#1c1917" strokeWidth="1.1"/>
              <text x="62" y="19"
                fontFamily="Georgia, 'Times New Roman', serif"
                fontSize="12" fontWeight="700"
                fill="#1c1917" textAnchor="middle"
                letterSpacing="1.5">vivekwarrier</text>
            </svg>
          </Link>
